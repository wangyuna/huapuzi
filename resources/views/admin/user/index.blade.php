	...
	<div class="mws-panel grid_8">
                    ...
                    <div class="mws-panel-body no-padding">
                        ...
                        <table class="mws-datatable mws-table dataTable" id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info">
                            <thead>
                                <tr role="row">
	                                ...
	                                <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 133px;" aria-label="Engine version: activate to sort column ascending">状态</th>
	                                <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 45px;" aria-label="CSS grade: activate to sort column ascending">操作</th>
                                </tr>
                            </thead>
                        ...
                        <tr class="odd">
                            ...
                            <td class=" ">@if($v['status'] == 0)超级管理员@else普通管理员@endif</td>
                            <td class=" ">
								<a href="/admin/user/delete/{{$v['id']}}" style="color:black;font-size:20px;margin-left:30px;" title="删除"><i class="icon-trash"></i></a>
								<a href="/admin/user/edit/{{$v['id']}}" style="color:black;font-size:20px;margin-left:46px;" title="修改"><i class="icon-wrench"></i></a>
                            </td>
                         </tr>
                         @endforeach
                        </tbody>
