...
<div class="mws-panel grid_8">
    ...
    <div class="mws-panel-body no-padding">
        ...
        <tr class="odd">
            ...
            <td class=" ">@if($v['huishou'] == 1) 显示 @else 隐藏 @endif</td>
            ...
            <td class=" ">
                @if($v['huishou'] == 1)
				<a href="/admin/pinglun/update/{{ $v['id'] }}" style="color:black;font-size:20px;margin-left:35px;" title="隐藏评论"><i class="icon-share-2"></i></a>
                @else
                <a href="/admin/pinglun/hupdate/{{ $v['id'] }}" style="color:black;font-size:20px;margin-left:35px;" title="显示评论"><i class="icon-share-2"></i></a>	
                @endif	
            </td>
         </tr>
         @endforeach
