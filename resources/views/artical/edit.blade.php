...
<div class="mws-panel grid_8">
     ...
     <div class="mws-panel-body no-padding">
          ...
          <form action="/admin/artical/update" method="post" enctype="multipart/form-data" class="mws-form">
               {{ csrf_field() }}
               ...
               <div class="mws-form-inline">
                    <div class="mws-form-row">
                         ...
                         <div class="mws-form-item">
                              <input type="text" name="title" class="small" value="{{$vo['title']}}">
                         </div>
               </div>
               <div class="mws-form-inline">
                    <div class="mws-form-row">
                         ...
                         <div class="mws-form-item">
                              <input type="text" name="des" class="small" value="{{$vo['des']}}">
                         </div>
               </div>
                <div class="mws-form-row">
                    <label class="mws-form-label">主图</label>
                    <img width="100px" src="{{$vo['pic']}}" alt="">
                </div>
               <div class="mws-form-row">
                    <label class="mws-form-label">改主图</label>
                    <div class="mws-form-item">
            ...
            <div class="mws-form-item">
              <script id="editor" type="text/plain" style="width:500px;height:300px;">{!!$vo['con']!!}</script>
            </div>
           </div>
