...
<body class="home">
    ...
    <header>
        <div class="logo" >
            ...
            <h1><a href="/home" style="background:url(/uploads/{{ session('config')[0]['logo'] }});"></a></h1>
            <i></i>
                ...
                <div class="quick_links_panel">
                    <div id="quick_links" class="quick_links">
                        ...
                        <li>
                            ...
                            <div class="mp_tooltip">
                                <a href="javascript:void(0)" class="history_list" style="color: #595656;font-size: 14px;width: 100%;background: #fff;border-radius: 3px 0 0 3px;">我的关注</a>
                                <i class="icon_arrow_right_white"></i>
                            </div>
                        </li>
                        <li>
                    ...
                    <div class="quick_toggle">
                        ...
                        <li>
                            ...
                            <div class="mp_tooltip">
                                <a href="http://www.hua.com/#top" class="return_top" style="color: #595656;font-size: 14px;width: 100%;background: #fff;border-radius: 3px 0 0 3px;">返回顶部</a>
                                <i class="icon_arrow_right_white"></i>
                            </div>
                        </li>
                    </div>
                </div>
                <div id="quick_links_pop" class="quick_links_pop quick_message_list" style="left: 0px;"><a href="javascript:;" class="ibar_closebtn" title="关闭"></a><div class="ibar_plugin_title"><h3>购物车</h3></div><div class="pop_panel"><div class="ibar_plugin_content"><div class="sub_title">共 <b>1</b> 件商品</div>
                @if(!empty(App\Http\Controllers\home\ShopController::cart()))
                @foreach(App\Http\Controllers\home\ShopController::cart() as $k => $v)
                <div class="com-list">
                <div class="img-box">
                <a href="/home/shop/{{ $v['gid'] }}">
                <img src="{{ trim($v['pic1'],'.') }}"></a></div>
                <div class="title"><a href="/home/shop/{{ $v['gid'] }}">{{ $v['title'] }}</a></div>
                <div class="price">
                <span class="price-sign text-primary">¥</span>
                <span class="price-num text-primary strong"><b>{{ $v['price2'] }}</b></span><span class="com-num">× 1</span></div></div>
                @endforeach
                @endif
                <div class="com-total"><div class="info"><b>1</b> 件商品
                <div class="price">
                <span class="price-sign text-primary">¥ </span><span class="price-num text-primary strong"> <b>298</b></span></div></div><a href="/home/doshop" class="btn btn-primary">去购物车结算</a></div></div><div class="arrow"><i></i></div><div class="fix_bg"></div></div></div>
            </div></div></div>
    <script src="/h/js/jquery-1.8.2.min.js"></script>        
    <script>
        // alert($);
        var num = 0;
        var i = 0;
        $('.com-list .price b').each(function(){
...
<script src="/h/js/layerpc/layer.js"></script>
