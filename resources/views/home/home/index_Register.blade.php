...
<div class="login-wrapper">
    ...
    <div class="container">
        <div class="login-box">
            ...
            <form action="/home/index_Register/insert" method="post" name="regForm" id="regForm">
                {{ csrf_field()}}
                <div class="tab-content">
                    ...
                    <div id="registerPane" class="tab-pane login-panel fade in active">
                        ...
                        @endif
                        <div class="login-notice" id="email" style="display: none;"><div class="notice-cont"><span class="ico ico-notice"></span>该邮箱已被注册！</div></div>
                        <div class="login-notice" id="Enr" style="display:none;"></div>
                        <div class="form-group">
                            <div class="email_autocomplete1">
                            <input name="email" autocomplete="off" placeholder="请填写您的Email地址" nodetype="email" value="{{ old('email') }}" type="text" id="Email" config="{width:304,height:40}">
                            </div>
                        </div>
                        <div class="form-group">
                            <input name="password" id="PassWord" type="password" class="form-control" placeholder="密码" value="{{ old('password') }}">
                        </div>
                        <div class="form-group">
                            <input id="RexPassWord" name="repassword" type="password" class="form-control" placeholder="再次输入密码" value="{{ old('repassword') }}">
                        </div>
...
<script>
    ...
    $("input[name='email']").blur(function (){
        // alert($(this).val());
        $.get('/home/index_Register/ajax', 'email='+$("input[name='email']").val(), function(str){
                // alert(str);
                if(str == 2){
