...
<div class="login-wrapper">
    ...
    <div class="container">
        <div class="login-box">
            <ul class="login-tabs">
                <li><a href="/home/index_Login/index">登录</a></li>
                <li class="active"><a href="javascript:void(0)">找回密码</a></li>
            </ul>


            <!-- 登录/注册tab End -->
            <!-- <a href="javascript:void(0);" class="logMethod">使用手机号码注册</a><div style="clear:both;"></div> -->
            <form action="/home/change" method="get" name="regForm" id="regForm">
                {{ csrf_field()}}
                <div class="tab-content">
                    ...
                    <div id="registerPane" class="tab-pane login-panel fade in active">
                        ...
                        @endif
                        <div class="login-notice" id="username" style="display: none;"><div class="notice-cont"><span class="ico ico-notice"></span>该邮箱不存在！</div></div>
                        <div class="login-notice" id="Enr" style="display:none;"></div>
                        <div class="form-group">
                            <div class="email_autocomplete1">
                            <input name="username" autocomplete="off" placeholder="请填写您注册时的Email地址" nodetype="email" value="{{ old('username') }}" type="text" id="Email" config="{width:304,height:40}">
                            </div>
                        </div>
                        <div class="form-group">
                            <input name="password" id="PassWord" type="password" class="form-control" placeholder="输入新密码" value="{{ old('password') }}">
                        </div>
                        <div class="form-group">
                            <input id="RexPassWord" name="repassword" type="password" class="form-control" placeholder="确认密码" value="{{ old('repassword') }}">
                        </div>
                        ...
                        <button class="btn btn-primary btn-lg btn-block" type="button" onclick="return Check_User_Login();">立即发送</button>
                    </div>
                    <!-- 注册 End -->
                </div>
            </form>
...
<script>
    ...
    $("input[name='username']").blur(function (){
        // alert($(this).val());
        $.get('/home/index_Register/ajax2', 'username='+$("input[name='username']").val(), function(str){
                // alert(str);
                if(str == 2){
...
@endsection
    ...
    <script>
        ...
        function CheckValidateCode() {
            ...
            if ((Validate_Code.value == "") || (Validate_Code.value.length < 5)) {
                ShowTips("请输入正确的验证码");
                return false;
            }
            //else{
