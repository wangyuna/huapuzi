...
<div class="mws-panel grid_8">
     ...
     <div class="mws-panel-body no-padding">
          ...
          <form action="/admin/help/supdate" method="post" class="mws-form">
               {{csrf_field()}}
               ...
               <div class="mws-form-inline">
                    <div class="mws-form-row">
                         ...
                         <div class="mws-form-item">
                            ...
                            <input type="text" readonly name="title" value="{{$vo1['name']}}"  class="small">
                 ...
                 <div class="mws-form-row">
                    ...
                    <div class="mws-form-item">
                        <script id="editor" type="text/plain" style="width:500px;height:300px;">{!!$vo['content']!!}</script>
                    </div>
               </div>
